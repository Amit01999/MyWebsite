    ...
    <Tilt className="mx-auto">
      ...
      >
        ...
        >
          ...
          <div className="max-sm:p-0 code-content p-3 font-mono text-sm text-gray-300 whitespace-pre-wrap leading-relaxed w-full h-full">
            <pre className="max-sm:text-xs max-sm:leading-snug max-sm:break-words overflow-hidden">
